...
set_string_index:
    ...
    mov byte [ g_string + eax ], '.'    ; g_string[ g_index ] = '.'
...
set_int_array_index:
    enter 0,0
    mov eax, [ g_index ]                        ; 64-bit address
    mov dword [ g_int_array + eax * 4 ], 646464 ; g_int_array[ g_index ] = 646464
...
set_long_array_index:
    ...
    mov qword [ g_long_array + rax * 8 ], 45 ; g_long_array[ g_index ] = 128128
