...
int main()
{
...
#if 0 // move value from g_value into g_index
    g_value = 333;
    g_index = 0;
    move_int_values();
    printf( "g_value: %d, g_index: %d\n\n", g_value, g_index );
#endif
#if 0 // move value from g_character into g_integer
    g_character = 111;
    g_integer = 0;
    move_char_to_int();
    printf( "g_character: %d, g_integer: %d\n\n", g_character, g_integer );
#endif
#if  0// move value from g_integer into g_longint
    g_integer = 1200300400 ;
    g_longint = 0;
    move_int_to_long();
    printf( "g_integer: %d, g_longint: %ld\n\n", g_integer, g_longint );
#endif
#if 0  // rewrite content of global string
    set_string();     
    printf( "g_string:'%s'\n\n", g_string );
#endif
    ...
    print_int_array();
#endif
#if 0 // rewrite one element of g_long_array at g_index position with g_value
    g_value = -2020;
    g_index = 0;
